...
public class ProfilePictureFragment extends Fragment implements View.OnClickListener {
    ...
    private void signUpSuccess(final Bitmap avatar) {
        ...
        final String fullName = mainFragment.getProfileInformationFragment().getFullName();
        final String email = mainFragment.getProfileInformationFragment().getEmail();
        String birthday = mainFragment.getProfileInformationFragment().getBirthday();
        boolean sex = mainFragment.getProfileInformationFragment().getSex();
