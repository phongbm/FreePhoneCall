...
public class ServerInfo {
    public static final String PARSE_APPLICATION_ID = "9jDOBlXCnnUv9PAF0BS0le4WaFgUpBd6Q2BpvbV5";
    public static final String PARSE_CLIENT_KEY = "YXSMuNeFEpCJM5qnXmOvzjJFdaG1Nxke95UAKpw1";
